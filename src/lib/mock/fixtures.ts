...
export const profiles: Record<UUID, Profile> = {
  [CURRENT_USER_ID]: { id: CURRENT_USER_ID, displayName: 'You', avatarUrl: null, notificationsEnabled: true },
  'user-sarah':  { id: 'user-sarah',  displayName: 'Sarah',  avatarUrl: null, notificationsEnabled: true },
  'user-john':   { id: 'user-john',   displayName: 'John',   avatarUrl: null, notificationsEnabled: true },
  'user-emma':   { id: 'user-emma',   displayName: 'Emma',   avatarUrl: null, notificationsEnabled: true },
  'user-david':  { id: 'user-david',  displayName: 'David',  avatarUrl: null, notificationsEnabled: true },
  'user-lisa':   { id: 'user-lisa',   displayName: 'Lisa',   avatarUrl: null, notificationsEnabled: true },
  'user-tom':    { id: 'user-tom',    displayName: 'Tom',    avatarUrl: null, notificationsEnabled: true },
  'user-anna':   { id: 'user-anna',   displayName: 'Anna',   avatarUrl: null, notificationsEnabled: true },
  'user-chris':  { id: 'user-chris',  displayName: 'Chris',  avatarUrl: null, notificationsEnabled: true },
  'user-sophie': { id: 'user-sophie', displayName: 'Sophie', avatarUrl: null, notificationsEnabled: true },
  'user-mark':   { id: 'user-mark',   displayName: 'Mark',   avatarUrl: null, notificationsEnabled: true },
  'user-julia':  { id: 'user-julia',  displayName: 'Julia',  avatarUrl: null, notificationsEnabled: true },
  'user-marko':  { id: 'user-marko',  displayName: 'Marko',  avatarUrl: null, notificationsEnabled: true },
  'user-ivan':   { id: 'user-ivan',   displayName: 'Ivan',   avatarUrl: null, notificationsEnabled: true },
  'user-luka':   { id: 'user-luka',   displayName: 'Luka',   avatarUrl: null, notificationsEnabled: true },
  'user-ante':   { id: 'user-ante',   displayName: 'Ante',   avatarUrl: null, notificationsEnabled: true },
  'user-josip':  { id: 'user-josip',  displayName: 'Josip',  avatarUrl: null, notificationsEnabled: true },
  'user-petar':  { id: 'user-petar',  displayName: 'Petar',  avatarUrl: null, notificationsEnabled: true },
  'user-nikola': { id: 'user-nikola', displayName: 'Nikola', avatarUrl: null, notificationsEnabled: true },
  'user-alex':   { id: 'user-alex',   displayName: 'Alex',   avatarUrl: null, notificationsEnabled: true },
  'user-ben':    { id: 'user-ben',    displayName: 'Ben',    avatarUrl: null, notificationsEnabled: true },
  'user-chloe':  { id: 'user-chloe',  displayName: 'Chloe',  avatarUrl: null, notificationsEnabled: true },
  'user-mike':   { id: 'user-mike',   displayName: 'Mike',   avatarUrl: null, notificationsEnabled: true },
  'user-rachel': { id: 'user-rachel', displayName: 'Rachel', avatarUrl: null, notificationsEnabled: true },
  'user-sam':    { id: 'user-sam',    displayName: 'Sam',    avatarUrl: null, notificationsEnabled: true },
  'user-ollie':  { id: 'user-ollie',  displayName: 'Ollie',  avatarUrl: null, notificationsEnabled: true },
  'user-jess':   { id: 'user-jess',   displayName: 'Jess',   avatarUrl: null, notificationsEnabled: true },
  'user-dan':    { id: 'user-dan',    displayName: 'Dan',    avatarUrl: null, notificationsEnabled: true },
  'user-amy':    { id: 'user-amy',    displayName: 'Amy',    avatarUrl: null, notificationsEnabled: true },
  'user-finn':   { id: 'user-finn',   displayName: 'Finn',   avatarUrl: null, notificationsEnabled: true },
  'user-grace':  { id: 'user-grace',  displayName: 'Grace',  avatarUrl: null, notificationsEnabled: true },
  'user-leo':    { id: 'user-leo',    displayName: 'Leo',    avatarUrl: null, notificationsEnabled: true },
  'user-nina':   { id: 'user-nina',   displayName: 'Nina',   avatarUrl: null, notificationsEnabled: true },
  'user-hugo':   { id: 'user-hugo',   displayName: 'Hugo',   avatarUrl: null, notificationsEnabled: true },
  'user-tara':   { id: 'user-tara',   displayName: 'Tara',   avatarUrl: null, notificationsEnabled: true },
  'user-will':   { id: 'user-will',   displayName: 'Will',   avatarUrl: null, notificationsEnabled: true },
  'user-zoe':    { id: 'user-zoe',    displayName: 'Zoe',    avatarUrl: null, notificationsEnabled: true },
}
...
function mkMember(leagueId: UUID, userId: UUID): LeagueMember {
  ...
  const profile =
    profiles[userId] ??
    ({ id: userId, displayName: userId.replace(/^user-/, ''), avatarUrl: null, notificationsEnabled: true } as Profile)
  return {
    leagueId,
    userId,
